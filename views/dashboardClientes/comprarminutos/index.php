        ...
        <div class="row">
            ...
            <main class="col-md-8 p-3">
                <div class="border border-dark rounded-3 bg-light p-3 mb-3">
                    ...
                    <p>En esta sección, puedes comparar los paquetes de minutos disponibles y seleccionar el que mejor se ajuste a tus necesidades. Todos los paquetes ofrecen llamadas ilimitadas siempre que tengas minutos disponibles en tu cuenta.</p>
                </div>
                ...
                <div class="border border-dark rounded-3 bg-light p-3 mb-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">A continuación, verás una tabla comparativa con los diferentes paquetes de minutos disponibles. Cada paquete incluye minutos ilimitados y puedes realizar tantas llamadas como desees, siempre que tengas minutos en tu cuenta.</p>
